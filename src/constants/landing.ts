...
export const TESTIMONIALS: Testimonial[] = [
	...
	{
		id: "tran-quoc-hung",
		quote: "We engaged Hùng Phát for our boutique hotel lobby — a space that needed to feel both imposing and welcoming. The Travertine collection they curated was perfect. Our guests comment on it daily.",
	...
	{
		id: "nguyen-lan-anh",
		quote: "Working with a ceramics supplier who truly understands interior design intent is rare. Hùng Phát understood our architect's vision and sourced materials that exceeded the specification. Exceptional.",
