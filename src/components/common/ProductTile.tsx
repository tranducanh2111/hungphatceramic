...
interface ProductTileProps {
	...
	className?: string;
	priority?: boolean;
	/** Lighter tile for catalog grids — CSS-only hover, tuned image quality. */
...
export function ProductTile({
	...
	const cardClassName = cn(
		...
		isCatalogTile && "group-hover:-translate-y-1 group-focus:-translate-y-1",
		className,
	);
