...
export function LandingHero() {
  ...
  return (
    <section ref={sectionRef} className="relative h-[150vh] w-full" style={{ position: "relative" }}>
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden bg-[#071A2B]">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_50%,#1A3D5C_0%,#071A2B_70%)]" aria-hidden="true" />
        ...
        >
          ...
          <motion.h1
            ...
            initial="hidden"
            animate="visible"
            className="mt-6 max-w-3xl font-serif text-display-xl font-light leading-[1.1] text-[#F4F4F6]"
          >
            Where Stone
            <br />
          ...
          <motion.p
            ...
            initial="hidden"
            animate="visible"
            className="mt-6 max-w-md font-sans text-body-lg text-[#F4F4F6]/70"
          >
