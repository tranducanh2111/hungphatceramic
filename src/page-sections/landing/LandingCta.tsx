...
const GOOGLE_MAPS_URL =
  "https://maps.google.com/?q=583+Giải+Phóng,+Giáp+Bát,+Hoàng+Mai,+Hà+Nội";
...
export function LandingCta() {
  return (
    <section className="relative overflow-hidden bg-[#0E2A42] py-28 lg:py-36">
      {/* Background glow */}
      <div
        className="absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#D4B886]/5 blur-[120px]"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center lg:px-12">
        ...
        >
          <Text variant="display-lg" className="mt-4 text-[#F4F4F6]">
            Ready to Define
            <br />
            <em className="italic text-[#D4B886]">Your Space?</em>
          </Text>
        </motion.div>
